...
public class RobotoCalendarView extends LinearLayout {
    ...
    public boolean shortWeekDays = false;
    ...
    public void setUpEventListeners() {
        ...
        leftButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                robotoCalendarListener.onDateChange(currentCalendar);
            }
        });
    ...
    public void clearSelectedDay(Calendar calendar) {
        if (calendar != null) {
    ...
    public String checkSpecificLocales(String dayOfTheWeekString, int i) {
    ...
    public OnLongClickListener onDayOfMonthLongClickListener = new OnLongClickListener() {
        @Override
    ...
    public ViewGroup getDayOfMonthBackground(Calendar currentCalendar) {
        return (ViewGroup) getView(DAY_OF_THE_MONTH_BACKGROUND, currentCalendar);
    }

    public TextView getDayOfMonthText(Calendar currentCalendar) {
        return (TextView) getView(DAY_OF_THE_MONTH_TEXT, currentCalendar);
    }

    public ImageView getCircleImage1(Calendar currentCalendar) {
        return (ImageView) getView(DAY_OF_THE_MONTH_CIRCLE_IMAGE_1, currentCalendar);
    }

    public ImageView getCircleImage2(Calendar currentCalendar) {
    ...
    public int getMonthOffset(Calendar currentCalendar) {
        Calendar calendar = Calendar.getInstance();
